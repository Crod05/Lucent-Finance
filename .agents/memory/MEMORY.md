...
- [Auth foundation patterns](auth-foundation-patterns.md) — provider isolation test-enforced; legacy claim fail-closed; auth built but unmounted until B-Beta activation.
